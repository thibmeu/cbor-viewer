(() => {
  ...
  var from = ({ name, prefix, encode: encode6, decode: decode8 }) => new Codec(name, prefix, encode6, decode8);
  ...
  // index.js
  var target = "https://advertisements.indexer.ipfs.cloudflare.com";
  var listener = (details) => {
    ...
    filter.onstop = (event) => {
      ...
      const jData = encode5(decode6(flatten));
      filter.write(jData);
      filter.disconnect();
    };
    return {};
  };
  var setJSONContentType = (e) => {
